  ...
  const SalaDeEspera = () => {
    ...
    return (
      <div>
        ...
        <div className="contenedorcajas">
          <div className="contenedorloader">
            <div className="loader ">
              ...
              <span className="cargando">Cargando Reunion...</span>
            </div>
          </div>
              ...
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <div className="container ">
                    ...
                    <p className="testimonio-texto">
                      Acordate de puntuar al medico despues de terminar la
                      consulta! Con esto nosotros podemos saber que medicos son
                      los mas recomendados para nuestros usuarios, En caso que
                      tengas una mala experiencia, acordate de que ademas de
                      puntuar, podes enviar un feedback de la situacion en
                ...
                <div className="carousel-item">
                  <div className="container">
                    ...
                    />
                    <p className="testimonio-texto">
                      Si detectas algo anormal o un mal funcionamiento de
                      nuestra pagina, podes avisarnos desde nuestra seccion de
                      soporte tecnico, agradecemos cada ayuda que nos envian o
                      cualquier problema que deseen que les informemos o
                      solucionemos
                    </p>
                    <div className="testimonio-info">
                      <Link to="/" target="_blank">
        ...
        <button type="button" onClick={atencionFinalizada}>
...
=======
>>>>>>> 74924c3a90f2425f327464b5435e646b2c25c013
