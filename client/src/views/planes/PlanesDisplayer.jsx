...
const pago = () => {
  axios 
  .post(`${apiUrl}/pagos/modelPago`, {dni_paciente:userlogin.numero_de_documento});

  axios
  .post(`${apiUrl}/pagos`, serv)
  .then((res) => window.open(res.data.init_point, "_blank"))
  .then(
     new swal('Gracias por solicitar nuestro servicio', 'Seras redirigido a Mercado Pago para completar la transaccion. Asegurate de tener habilitadas las pestañas emergentes', 'success'))
}
